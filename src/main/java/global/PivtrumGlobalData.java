...
public class PivtrumGlobalData {
    ...
    public static final String[] TRUSTED_NODES = new String[]{"iquidus.rainbit.me", "bulwark.rainbit.me", "rnbit1.rainbit.me"};
    ...
    public static final List<PivtrumPeerData> listTrustedHosts(){
        ...
        for (String trustedNode : TRUSTED_NODES) {
            list.add(new PivtrumPeerData(trustedNode,29116,55552));
        }
        return list;
    }
